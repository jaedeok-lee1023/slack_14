...
def main():
    for cluster in clusters:
        ...
        notice_msg = (
            ...
            f"\n\n"
            f"*투명하고 정확한 컬리 자산 관리*를 위해 *<https://static.wixstatic.com/media/50072f_a28bb0e25f5940768dd1a4facad2729d~mv2.png|[부서별 자산 담당자]>* 와 *[자산관련 준수사항]* 에 대해 공유 드립니다.\n\n"
            f"\n"
            f"구성원 여러분들의 많은 도움과 협조를 통해 건강하고 안전한 우리 클러스터가 되도록 부탁드립니다.\n"
            f"\n"
            f"\n"
            f"📌 *작업 목록:*\n"
            f"1️⃣ 자산 (아래 취급품목 참고)에 대해서 *위치 이동이 필요할 경우 [부서 자산 담당자] 내용 공유*:bangbang:\n"
            ...
            f"\n\n"
            f":phone: *문의사항* : 총무/시설_담당자 <@U05NUU65F19> <@U05P7L4MY1F> \n\n"
            f"감사합니다.  😊\n"
            f"\n"
        )
